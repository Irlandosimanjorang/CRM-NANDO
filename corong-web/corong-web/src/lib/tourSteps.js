...
export const TOUR_STEPS = [
  ...
  { key: "leads", minLevel: 0, title: "Leads", desc: "Kartu lead per perusahaan, drag antar tahap pipeline, catat progress harian. Ada juga AI Draft Follow-up (WhatsApp & Email) dan Deteksi Duplikat otomatis." },
