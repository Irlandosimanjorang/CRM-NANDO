          ...
          {loading ? <Splash inline /> : (
            <>
              ...
              <div style={{ display: effectiveTab === "dashboard" ? "block" : "none" }}>
                <Dashboard leads={leads} stages={stageList} dealTransactions={dealTransactions} settings={settings} onGo={setTab} onOpenLead={setEditLead} myLevel={myLevel} onChanged={reload} isEnterprise={isEnterprise} />
              </div>
