    ...
    <div className="nexto-app min-h-screen bg-[#f5f7fb] text-slate-900 flex overflow-x-hidden">
      ...
      <aside className="nexto-sidebar hidden md:flex flex-col w-[248px] sticky top-0 h-screen shrink-0 text-white border-r border-white/[0.06]">
        <div className="px-5 pt-5 pb-4">
          <div className="flex items-center gap-3">
            <div className="relative flex h-10 w-10 items-center justify-center rounded-[14px] border border-white/10 bg-white/[0.06] shadow-[0_8px_25px_-12px_rgba(249,115,22,.7)]">
        ...
        <div className="px-4 pb-3">
          <div className="rounded-2xl border border-white/[0.07] bg-white/[0.035] px-3 py-2.5">
            <div className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-emerald-400 nexto-status-dot" />
              <span className="text-[10px] font-semibold text-slate-300">Workspace aktif</span>
              <span className="ml-auto text-[9px] text-slate-600">{isPremium ? "PRO" : "FREE"}</span>
            </div>
          </div>
        </div>

        <nav className="flex-1 px-3 py-2 space-y-1 overflow-y-auto">
          <div className="px-3 pb-2 text-[9px] font-bold uppercase tracking-[0.2em] text-slate-600">Workspace</div>
          {NAV.map((n) => {
            const I = n.icon;
      ...
      <div className="flex-1 min-w-0 flex flex-col relative nexto-content-glow">
        ...
        <header className="hidden md:flex sticky top-0 z-20 h-[68px] items-center justify-between border-b border-slate-200/70 bg-white/72 px-6 lg:px-8 backdrop-blur-2xl">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden lg:flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3.5 py-2 text-[10px] text-slate-400">
